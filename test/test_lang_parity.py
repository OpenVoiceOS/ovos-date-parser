...
LANGS = ["ar", "ast", "az", "ca", "cs", "da", "de", "en", "es", "eu", "fa", "fr",
         "gl", "hu", "it", "kab", "nb", "nl", "nn", "oc", "pl", "pt", "ro", "ru",
         "sl", "sv", "uk"]
...
_TOMORROW = {
    ...
    "it": "domani", "kab": "azekka", "nb": "i morgen", "nl": "morgen",
    "nn": "i morgon", "oc": "deman", "pl": "jutro", "pt": "amanhã",
...
_NO_DATE = {
    ...
    "nn": "hei korleis går det", "nl": "hallo hoe gaat het",
...
_DURATION_STRINGS = {
    ...
    "nn": "10 minutt", "nl": "10 minuten", "pl": "10 minut",
