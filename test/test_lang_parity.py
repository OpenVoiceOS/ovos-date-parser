...
LANGS = ["ar", "ast", "az", "ca", "cs", "da", "de", "el", "en", "es", "eu", "fa",
         "fr", "gl", "he", "hu", "it", "kab", "nl", "oc", "pl", "pt", "ro", "ru",
         "sl", "sv", "uk"]
...
_NO_DATE = {
    ...
    "el": "γεια σου τι κάνεις", "he": "שלום מה שלומך",
...
_DURATION_STRINGS = {
    ...
    "da": "10 minutter", "de": "10 minuten", "el": "10 λεπτά", "he": "10 דקות",
    "en": "10 minutes",
