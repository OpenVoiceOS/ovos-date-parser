...
from ovos_number_parser.numbers_bg import pronounce_number_bg
...
def nice_time_bg(dt, speech=True, use_24hour=True, use_ampm=False):
    ...
    For example, generate 'осем и тридесет' for speech or '8:30' for
    text display.
...
# prepositions introducing a future offset ("след 5 минути")
_FUTURE_PREPS_BG = ('след', 'в', 'за')
